...
enum TypeMovie { upcoming, topRated, nowPlaying, popular }
    ...
    _pagingController.addPageRequestListener((pageKey) {
      switch (widget.type) {
        case TypeMovie.upcoming:
          context.read<MovieGetUpcomingProvider>().getUpcomingWithPaging(
                context,
        ...
        case TypeMovie.popular:
          context.read<MovieGetPopularProvider>().getPopularWithPaging(
                context,
                pagingController: _pagingController,
                page: pageKey,
              );
      ...
      appBar: AppBar(
        title: Builder(builder: (_) {
          switch (widget.type) {
            ...
            case TypeMovie.popular:
              return const Text('Now Popular Movies');
          }
        }),
